...
import usePlayback, {playingSelector} from "../../../states/FramesStates";
import {SpringPlay} from "../../../../server/classes/springboard";

export default function Controls({response}: { response: SpringPlay }) {
    ...
    return (
        <div className={styles.c}>
            ...
            <div className={styles.center} onClick={e => e.stopPropagation()}>
                ...
                <button className={styles.vpb} onClick={playPause}>
                    <svg
