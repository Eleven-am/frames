...
>(({ className, ...props }, ref) => (
    <tr
        ...
        className={
            tw(
                'border-b border-lightest transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted',
                className,
            )
        }
        {...props}
...
>(({ className, ...props }, ref) => (
    <td
        ref={ref}
        className={tw('p-2 align-middle [&:has([role=checkbox])]:pr-0', className)}
        {...props}
    />
));
